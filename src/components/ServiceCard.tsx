...
const ServiceCard: React.FC<ServiceCardProps> = ({
  ...
  return (
    <div className="flex flex-col rounded-xl shadow-lg overflow-hidden bg-white border border-gray-100">
      {/* Hero - optimized smaller image */}
      <div className="relative">
        <img src={img} alt={titleFr} className="h-28 md:h-36 w-full object-cover" />
        <div className="absolute inset-0 bg-gradient-to-t from-blue-deep/60 via-blue-deep/20" />
      ...
      <div className="p-6 flex-1 flex flex-col gap-4">
        <div>
          <h3 className="text-lg font-semibold text-blue-deep">
