    ...
    <section className="py-20 bg-gray-50">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-4xl lg:text-5xl font-bold text-blue-deep mb-6 font-serif">
          ...
          <div className="w-24 h-1 bg-blue-deep mx-auto mt-6 rounded-full"></div>
        </div>
            ...
            {steps.map((_, index) => (
              <React.Fragment key={index}>
                ...
                {index < steps.length - 1 && (
                  <div className="w-8 h-0.5 bg-blue-deep"></div>
                )}
              </React.Fragment>
            ))}
          </div>
